package modules.NestedClasses.challenges.challenge2;

import modules.NestedClasses.challenges.challenge2.domain.Employee;
...
//        };
        ...
        list.sort(new Comparator<MyEmployee>() {
